...
const bodies = {
    ...
    uk: () => (
        <>
            <p>
                Колись я починала в колл-центрі. Годинами повторювала скрипти,
                поки люди часто мали на увазі щось інше.
                У KLM я зрозуміла: співпраця працює лише тоді, коли всі розуміють одні й ті самі сигнали.
                Тепер в IT я впізнаю той самий пошук: як зробити щось складне, як код, людяним і зрозумілим?
            </p>
            <h2>ШІ: між хайпом і практикою</h2>
            <p>
                Усі говорять так, ніби ШІ стане другим пілотом.
                Але для мене це більше схоже на стажера, що надзвичайно швидко друкує —
                корисний, але за ним треба стежити.
                Іноді блискучий, іноді — нісенітниця. ШІ прискорює роботу, але не бере керування сам.
            </p>
            <h2>Дистанційна робота: видимість без кавового кивка</h2>
            <p>
                Після пандемії дистанційна робота стала нормою.
                Але ти втрачаєш тонкі сигнали: кивки, погляди, неформальні розмови.
                GitHub, Slack і Figma — твої нові колеги.
                Треба навчитися «розмовляти» з ними і вносити ясність до того, як питання накопичаться.
            </p>
            <h2>Структура і свобода</h2>
            <p>
                ШІ може розпізнавати патерни, давати пропозиції, але надавати смисл?
                Це залишається людською роботою. Ти бачиш зв'язки, емоції, вибори.
                Дошка із завданнями або сітка в дизайні — це не корсет,
                а простір для руху та зростання.
            </p>
            <h2>Що ШІ може робити з нашими даними: для нас чи проти нас?</h2>
            <p>
                Ось де стає цікаво. Системи ШІ працюють на даних.
                А з усією інформацією, що збирається про нас —
                що ми клікаємо, що лайкаємо, де знаходимося — виникає влада.
            </p>
            <p>
                <strong>Зловживання:</strong> ШІ може передбачати, що ти відчуваєш, що купуєш, куди рухаєшся, і використовувати це проти тебе (реклама, маніпуляція).{" "}
                <strong>Придушення:</strong> в авторитарних режимах ШІ може використовуватися для стеження, цензури та соціального контролю.{" "}
                <strong>Упередженість:</strong> якщо дані упереджені, ШІ повторюватиме рішення, що підтримують нерівність.
            </p>
            <p>
                З іншого боку:{" "}
                <strong>Персоналізація:</strong> ШІ може давати поради, дійсно адаптовані до тебе, кращу освіту, медичну допомогу, доступність.{" "}
                <strong>Підсилення:</strong> ШІ може слугувати помічником, другою парою очей — не щоб замінити, а щоб зробити тебе сильнішим.{" "}
                <strong>Інновації та ефективність:</strong> вирішення складних проблем довкілля, охорони здоров'я та логістики способами, недоступними людині на самоті.
            </p>
            <h2>Яку ШІ обрати: американську, французьку чи китайську?</h2>
            <p>Зараз відбувається гонка між моделями ШІ з різними підходами:</p>
            <ul>
                <li><strong>ChatGPT (США / OpenAI)</strong> — потужний, багато документації, але працює за американськими законами, іноді з обмеженнями поза США.</li>
                <li><strong>Mistral (Франція / ЄС)</strong> — з акцентом на європейські цінності, потенційно суворіші правила конфіденційності, кращий контроль над суверенітетом даних.</li>
                <li><strong>Claude (Anthropic / США)</strong> — часто позиціонується як «більш безпечний ШІ», з більшими заходами проти дезінформації.</li>
                <li><strong>Китайські моделі ШІ (Baidu Ernie, Tencent AI, Huawei)</strong> — побудовані в інакше регульованій системі. Потенційно потужні у масштабі, але з різними ризиками щодо цензури, доступу до даних і державного втручання.</li>
            </ul>
            <h2>Моя позиція і мої сумніви</h2>
            <p>
                Я використовую ШІ — так, і обережно. Не сліпо. Я бачу його як інструмент, а не авторитет.
                Думаю, зараз ми посередині вибору: або дозволяємо технології визначати, як ми живемо, або
                будуємо технологію, яка робить людей сильнішими. Я не знаю, чи обрала правильний напрямок.
                Іноді думаю: може, я надто наївна? Але вірю, що людяність, цікавість і критичні вибори
                можуть вести нас — не ідеально, але значуще.
            </p>
        </>
    ),
};
...
const ui = {
    ...
    uk: { back: "← Назад до журналу", date: "22 вересня 2025", read: "~5 хв читання", shareTitle: "Майбутнє технологій", shareText: "Про ШІ, дистанційну роботу, дані та людяність в IT." },
};
