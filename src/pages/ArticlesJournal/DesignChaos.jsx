...
const bodies = {
    ...
    uk: () => (
        <>
            <p>
                У мене є слабкість до хаосу. Не до великого апокаліптичного хаосу катастрофічних фільмів,
                а до щоденного: забагато відкритих вкладок, три напівзакінчені ескізи на столі, баг у коді,
                який знаходиш лише о 23:47, і ще лист від давнього друга, що вже три дні не прочитаний у папці вхідних.
            </p>
            <p>
                Хаос відчувається живим. Він бурхливий, творчий, іноді навіть комфортний. Але настає момент,
                коли хаос перетворюється на шум. Тоді вже не перебуваєш у потоці, а продираєшся через болото
                питань «де ж я зупинився?». Саме тут починається моя любов до структури.
            </p>
            <p>
                Не до холодної, Excel-подібної структури, що гасить усе довкола, а до тієї, що дає простір для дихання.
                Як ритм у музиці: чуєш каданс, і в його межах можеш імпровізувати.
            </p>
            <p>
                У KLM я зрозуміла: без чітких домовленостей буквально не злетиш. Спробуй посунути Boeing 777
                назад без координації — відчуття гарантоване. У муніципалітеті я виявила, що комунікація без структури
                схожа на нараду, де всі говорять одночасно: багато енергії, нуль результату.
            </p>
            <p>
                І тепер, як junior розробник, я бачу: код — це те саме. Функція тут, клас там — і раптом
                виникає патерн. Там, де раніше стояла стіна незрозумілих дужок, з'являється порядок:
                система, яка працює, розширюється і навіть може бути елегантною.
            </p>
            <p>
                Смішно, але структура дає свободу. Гарна сітка в дизайні залишає місце для гри.
                Охайна кодова база полегшує експерименти. Це як друкарська машинка з міжрядковим інтервалом:
                саме завдяки лініям можна відриватися зі словами.
            </p>
            <p>
                Мені довелося це вивчити, бо роками я думала, що структура мене обмежуватиме. Що правила —
                це обмеження. Але справжнє обмеження полягало в нескінченних пошуках, у незнанні, з чого
                починати, бо не було фундаменту.
            </p>
            <p>
                Структура — не в'язниця. Це батут. Стрибаєш вище, приземляєшся м'якше і наважуєшся на більше,
                бо знаєш: страхувальна сітка витримає.
            </p>
            <p>
                Може, все це звучить дуже красиво, але чесно? Я досі часто спотикаюся. Відкриваю двадцять
                вкладок, забуваю крапку з комою або проєктую щось, що підозріло схоже на PowerPoint початкової школи.
                Але нічого. Хаос — частина процесу, це паливо. Структура — не гальмо; це те, що дає тобі поштовх.
            </p>
        </>
    ),
};
...
const ui = {
    ...
    uk: { back: "← Назад до журналу", date: "24 серпня 2025", read: "~4-5 хв читання", shareTitle: "Про хаос, структуру, код і дизайн.", shareText: "Чому структура — це не нудно, а свобода." },
};
...
const titles = {
    ...
    uk: "Чому структура — це не нудно, а саме свобода",
};
