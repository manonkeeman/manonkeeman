...
const content = {
    ...
    uk: {
        ...
        date: "18 лютого 2018",
        readLabel: "Довге читання",
        title: "Авіаційні сім'ї, Інтерв'ю Up in the Sky",
        shareTitle: "Авіаційні сім'ї, Частина 3 (2018)",
        shareText: "Покоління, пов'язані пристрастю до авіації.",
        p1: <>
            Для багатьох це казка: пілот, який зустрічає стюардесу. Частина 3 серії{" "}
            <em>Авіаційні сім'ї</em> — про цю казку. Незважаючи на розлучення з пілотом Lufthansa,
            авіація продовжує відігравати центральну роль у моєму житті, особливо після стосунків
            із Максімом Сталем, другим пілотом KLM на Boeing 777/787.
        </>,
        p2: <>
            Оригінальне інтерв'ю вийшло у 2018 році на Up in the Sky.{" "}
            <a href="https://www.upinthesky.nl/2018/02/18/luchtvaartfamilies-deel-3-longread/" target="_blank" rel="noreferrer">
    ...
    return (
        <section id="luchtvaartfamilie2018" className="section section-alt">
            <div className="container article-container">
                ...
                <ArticleFooter shareTitle={c.shareTitle} shareText={c.shareText} />
