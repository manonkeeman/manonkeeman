...
const bodies = {
    ...
    uk: () => (
        <>
            <p>
                Люди іноді думають, що моя кар'єра — це звивистий шлях. KLM, муніципалітет Амстердаму,
                графічний дизайн, і тепер код. Але коли я озираюся назад, бачу одну пряму лінію:
                я завжди хотіла розуміти системи. І коли я їх розумію, хочу їх будувати.
            </p>
            <hr className="rule" />
            <h2>Амстердам: комунікація як система</h2>
            <p>
                Після повернення з Мюнхена я почала в муніципалітеті Амстердаму як оператор
                колл-центру в DWI. Я швидко виявила, що комунікація сама по собі є системою:
                хто що говорить, через який канал, з яким ефектом. У вільний час я зробила з
                колегами корпоративний журнал, який мав такий успіх, що я перейшла до внутрішніх
                комунікацій. Моє завдання: залучити 16 000 колег до активної роботи в інтранеті.
                Мій перший великий проєкт у масштабі, і я вже не могла відірватися від структури,
                що лежала в основі.
            </p>
            <hr className="rule" />
            <h2>На перроні: сигнали, системи та безпека</h2>
            <p>
                Коли поєднувати роботу та догляд за дитиною як мати-одиначка стало занадто важко,
                я обрала гнучку роботу в KLM. Я працювала наземним стюардесою та вантажником, і під
                час пандемії була відібрана для докусоупу{" "}
                <em>KL2020 Повернення в небо</em>, разом із генеральним директором Пітером Елберсом.
                Зрештою я вступила на трирічне навчання, щоб стати оператором тягача та pushback.
            </p>
            <p>
                На перроні все обертається навколо точності. Жодних розмитих жестів: знаєш точно,
                хто, коли і що робить. Короткі перевірки, чіткі сигнали, безперервний зворотний
                зв'язок. Рухати літаком у 80 тонн назад — це не питання сили, а комунікації та
                тайминга. Це навчило мене, як управляти складними процесами: розбиваючи їх на
                маленькі, контрольовані кроки.
            </p>
            <hr className="rule" />
            <h2>Від системного мислення до будівництва систем</h2>
            <p>
                Після років змінної роботи, ранніх ранків і пізніх ночей на льотному полі прийшов
                час для чогось іншого. Не менш інтенсивного, але з більшим контролем над власним
                часом. Я завжди будувала сайти та працювала графічним дизайнером, але тепер хотіла
                йти глибше. Що насправді ховається за вебсторінкою? Як frontend розмовляє з backend?
                Як забезпечити надійний потік даних від бази даних до екрана?
            </p>
            <p>
                Через Novi College та Equals, мережу підтримки жінок у техніці, я розпочала
                інтенсивне навчання Full Stack розробки. React, Spring Boot, бази даних, REST
                API, Git. Одразу клацнуло. Не тому що було легко, а тому що спосіб мислення
                здавався знайомим: аналізувати систему, розуміти шари, знати, як частини
                спілкуються між собою. Саме те, що я вивчила на перроні, але тепер у коді.
            </p>
            <p>
                Налагоджувати баги насправді не так вже й відрізняється від вирішення проблеми
                на перроні. Шукаєш, де система відхиляється від очікуваної поведінки, відстежуєш
                до джерела і виправляєш. Методично, спокійно, крок за кроком.
            </p>
            <hr className="rule" />
            <h2>Зараз</h2>
            <p>
                Я почала з того, що штовхала літаки назад. Тепер я будую системи вперед.
                Перехід від перрону до продуктової команди здається великим, але суть залишилася
                тією самою: розуміти, як щось працює, знати, де втрутитися, і щодня задавати
                дещо гостріші питання. Лише гарнітура була замінена на клавіатуру, і це відчувається
                так само захоплюючо.
            </p>
        </>
    ),
...
const ui = {
    ...
    uk: { back: "← Назад до журналу", date: "1 вересня 2025", read: "~5 хв читання", shareTitle: "Від буксирувальника літаків до Full Stack розробника", shareText: "Читай мою історію від перону до продуктової команди." },
};
